...
public static class InternalTrace
{
    ...
    {
        return new Logger(name, level, _traceWriter ?? TextWriter.Null);
    }
    ...
    {
        return GetLogger(TypeName(type), level);
    }
    ...
    {
        return new Logger(name, DefaultTraceLevel, _traceWriter ?? TextWriter.Null);
    }
    ...
    {
        return GetLogger(TypeName(type), DefaultTraceLevel);
    }
