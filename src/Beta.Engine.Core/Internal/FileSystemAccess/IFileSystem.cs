namespace Beta.Engine.Internal.FileSystemAccess;
...
public interface IFileSystem
{
    ...
    /// <returns>
    ///     <see langword="true" /> if <paramref name="directory" /> points to an existing directory;
    ///     <see langword="false" /> otherwhise.
    /// </returns>
    ...
    /// <returns>
    ///     <see langword="true" /> if <paramref name="file" /> points to an existing file; <see langword="false" />
    ///     otherwhise.
    /// </returns>
    ...
    ///     <paramref name="path" /> is empty or contains invalid characters (see
    ///     <see cref="SIO.Path.InvalidPathChars" /> for details).
    /// </exception>
    ...
    /// <exception cref="System.ArgumentNullException"><paramref name="path" /> is <see langword="null" />.</exception>
    /// <exception cref="System.ArgumentException">
    ///     <paramref name="path" /> is empty, contains no file-name or contains invalid
    ///     characters (see <see cref="SIO.Path.GetInvalidFileNameChars" /> for details).
    /// </exception>
    /// <exception cref="System.IO.PathTooLongException">The specified path exceeds the system-defined maximum length.</exception>
    /// <exception cref="System.UnauthorizedAccessException">Access to <paramref name="path" /> is denied.</exception>
    /// <exception cref="System.NotSupportedException">
    ///     <paramref name="path" /> contains a colon (:) in the middle of the
    ///     string.
    /// </exception>
    /// <exception cref="System.IO.DirectoryNotFoundException"><paramref name="path" /> points to a non-existing directory.</exception>
