namespace Beta.Engine.Internal.Backports;
...
public static class Path
{
    ...
    /// </exception>
    /// <remarks>
    ///     See https://docs.microsoft.com/en-us/dotnet/api/system.io.path.ispathfullyqualified for original
    ///     implementation.
    /// </remarks>
    public static bool IsPathFullyQualified(string path)
    {
        ...
        return RunningOnWindows()
            ? PathUtils.IsFullyQualifiedWindowsPath(path)
            : PathUtils.IsFullyQualifiedUnixPath(path);
    }
