...
/// </summary>
/// <param name="Suite">The instance of the type holding the test.</param>
...
[PublicAPI]
public record BetaTest(object Suite, IEnumerable<object>? Input, string TestName, Func<object, Proof> Apply)
{
    /// <summary>
    ...
    public BetaTest(object suite, string testName, Func<Proof> apply)
        : this(suite, null, testName, _ => apply())
    {
    }
    ...
    // /// </summary>
    // public Assembly Assembly => Suite.GetType().Assembly;
    //
    // /// <summary>
    // ///     Gets the declaring type of the test.
    // /// </summary>
    // public string DeclaringType => Suite.GetType().FullName!;
    //
    // /// <summary>
...
public record BetaTest<TInput> : BetaTest
{
    ...
    /// <param name="testName">The name of the test.</param>
    /// <param name="apply">The apply method for the test.</param>
    public BetaTest(object suite, IEnumerable<TInput> input, string testName, Func<TInput, Proof> apply)
        : base(suite, (IEnumerable<object>)input, testName, o => apply((TInput)o))
    {
    }
}
